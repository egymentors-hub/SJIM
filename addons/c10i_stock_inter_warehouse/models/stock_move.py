            ...
            for picking in pickings:
                ...
                for move in picking.move_lines:
                    ...
                    for quant in move.quant_ids:
                        if quant.cost not in dict_product_cost_price[move.product_id.id].keys():
                            dict_product_cost_price[move.product_id.id].update({quant.cost: 0.0})
                        dict_product_cost_price[move.product_id.id][quant.cost] += quant.qty
