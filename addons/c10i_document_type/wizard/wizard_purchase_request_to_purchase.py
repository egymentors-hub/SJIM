    ...
    def create_purchase(self):
        ...
        for header in self.partner_ids:
            values_header = {
                ...
                'picking_type_id': self.line_ids[-1] and self.line_ids[-1].request_id and self.line_ids[
                    -1].request_id.picking_type_id and self.line_ids[-1].request_id.picking_type_id.id or False
            }
